...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${jetbrains.variable} scroll-smooth dark`}
    ...
    >
      <body className="min-h-screen bg-background text-foreground tracking-tight flex flex-col antialiased relative overflow-x-hidden">
        ...
        <div className="fixed inset-0 z-50 pointer-events-none bg-noise mix-blend-overlay opacity-[0.03]" />
